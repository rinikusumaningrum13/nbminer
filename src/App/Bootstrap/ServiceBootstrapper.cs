using NbMiner.App.Commands;
using NbMiner.ChainProviders.Evm;
using NbMiner.ChainProviders.Transport;
using NbMiner.ChainProviders.Utxo;
using NbMiner.Cryptography.Derivation;
using NbMiner.Cryptography.Vault;
using NbMiner.Engine.Analytics;
using NbMiner.Engine.Domain.Contracts;
using NbMiner.Engine.Networks;
using NbMiner.Engine.Options;
using NbMiner.Engine.Orchestration;
using NbMiner.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace NbMiner.App.Bootstrap;
